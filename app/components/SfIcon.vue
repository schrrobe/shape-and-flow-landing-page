...
const symbole = {
  ...
  haus: {
    gefuellt: false,
    pfade: ['M3 10.2 12 3.5l9 6.7V20a1 1 0 0 1-1 1h-4.5v-6.5h-7V21H4a1 1 0 0 1-1-1Z'],
  },
  funke: {
    gefuellt: false,
    pfade: [
...
const props = defineProps<{
  name: keyof typeof symbole
}>()

const symbol = computed(() => symbole[props.name])
</script>
...
<template>
  <svg
    ...
    viewBox="0 0 24 24"
    :fill="symbol.gefuellt ? 'currentColor' : 'none'"
    :stroke="symbol.gefuellt ? undefined : 'currentColor'"
    stroke-width="1.5"
    ...
    focusable="false"
  >
    <path v-for="pfad in symbol.pfade" :key="pfad" :d="pfad" />
  </svg>
</template>
