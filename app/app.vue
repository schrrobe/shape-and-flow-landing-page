 ...
 *
 * The cast is needed because unhead only types the registered link relations, and two of the five
 * — api-catalog and agent-skills — are not among them. rel is an extensible token list, so they
 * are allowed; only the type does not know them.
 */
...
useHead({
   ...
   * API catalogue, the Agent Skills index and llms.txt.
   *
